...
const innovations = [
  ...
  },
  {
    ...
    image: "/innovation5.png",
    category: "Sustainability",
    status: "Implementation"
  },
  {
    title: "Smart Monitoring Systems",
    description: "IoT-enabled real-time patient monitoring and medication adherence tracking",
    image: "/innovation6.png",
                  ...
                  <div className="relative h-48 bg-gradient-to-br from-purple-100 to-blue-100">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        ...
                        innovation.status === 'Active' ? 'bg-gray-100 text-gray-800' :
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-6">
                  <div className="flex">
                    <div className="flex-shrink-0 w-4 h-4 bg-gray-600 rounded-full mt-1"></div>
                    <div className="ml-4">
