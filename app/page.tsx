  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col space-y-3">
        {/* WhatsApp Button */}
        <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white w-12 h-12 rounded-full shadow-lg hover:bg-green-600 transition-colors flex items-center justify-center">
        ...
        {/* Chat Box */}
        <div className="bg-black rounded-full shadow-2xl p-4 w-12 h-12 flex items-center justify-center hover:w-80 hover:h-auto hover:rounded-lg transition-all duration-300 group">
          <svg className="w-6 h-6 text-white group-hover:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl mb-8 text-blue-100">
                  NR Medicare is a pharmaceutical manufacturing company committed to delivering high-quality, affordable, and reliable medicines that support better health outcomes. With a strong focus on quality, compliance, and innovation, the company specializes in the development and manufacturing of a wide range of pharmaceutical formulations designed to meet the evolving needs of healthcare professionals and individuals.
                </p>
              </div>
